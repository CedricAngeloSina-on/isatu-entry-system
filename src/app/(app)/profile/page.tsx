      ...
      <>
        ...
        >
          ...
          <div className="relative aspect-[27/17] w-[480px] max-w-full overflow-hidden rounded-lg border bg-[url('/id_bg.jpg')] bg-cover bg-center shadow-md">
            ...
            <div className="absolute top-0 right-0 left-0 z-10 flex h-[15%] items-center justify-between px-4 text-white">
            ...
            <div className="absolute right-0 bottom-0 left-0">
              <div className="flex flex-row gap-2 p-3 pt-4 text-xs">
                {/* Left: Photo */}
